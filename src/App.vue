<template>
  <div>
    ...
    <nav id="navbar" class=" pb-1 bg-gradient-to-r from-gray-100 via-gray-100 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-800 fixed left-0 w-full z-20 top-0 mb-5 p-1 text-lg transition-transform duration-300 transform ">
         ...
         <div class="absolute inset-y-0 left-0 flex items-center sm:hidden ">
          ...
          <div v-if="navOpen" class="px-8 sm:hidden p-4 rounded  absolute right-4 top-16 z-10 w-48 origin-top  ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
            <div class="w-full h-screen fixed z-10 top-0 left-0 bg-sky-900 py-1 shadow-lg ring-1 ring-black max-w-40" @click="navOpen = false">  
              <router-link class=" rounded bg-sky-900 block px-4 py-2 text-sm text-green-200" to="/" role="menuitem" tabindex="-1" id="user-menu-item-3">Home</router-link>              
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-20 px-80 ">
                ...
                <router-link to="/" class="text-sky-900 dark:text-green-600 hover:dark:text-sky-100 hover:dark:bg-sky-700 hover:bg-sky-300 rounded-md px-3 py-2 text-sm font-medium hover:text-sky-900">Home</router-link>
                <router-link to="contact" class="text-sky-900 dark:text-green-600 hover:dark:text-green-100 hover:dark:bg-sky-700 hover:bg-sky-300 rounded-md px-3 py-2 text-sm font-medium hover:text-sky-900  ">Contact</router-link>
                <router-link to="about" class="text-sky-900 dark:text-green-600 hover:dark:text-sky-100 hover:dark:bg-sky-700 hover:bg-sky-300 rounded-md px-3 py-2 text-sm font-medium hover:text-sky-900 ">About</router-link>
                <router-link to="more" class="text-sky-900 dark:text-green-600 hover:dark:text-sky-100 hover:dark:bg-sky-700 hover:bg-sky-300  rounded-md px-3 py-2 text-sm font-medium  hover:text-sky-900">More</router-link>
                <router-link to="help" class="text-sky-900 dark:text-green-600 hover:dark:text-sky-100 hover:dark:bg-sky-700 hover:bg-sky-300  rounded-md px-3 py-2 text-sm font-medium hover:text-sky-900">Help</router-link>
              </div>
            </div>
          </div>
        </div>
    ...
    <!-- Content Section -->
    <div class="pt-16 bg-gray-200 dark:bg-gray-900">
      <router-view  />
    </div>
